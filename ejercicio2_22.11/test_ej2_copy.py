...
fullpath="/home/administrator/obligatorio/ejercicio2_python/aux" #Full Path donde se ubica el archivo auxiliar #"/home/administrator/obligatorio/ejercicio2_python/aux"
        ...
        if os.access(ubicacion, os.R_OK) and os.access(ubicacion, os.X_OK) == True:
            ...
            if suma == 7: 
                ...
                with open(fullpath,'w') as salida:
                    ...
                    # Lo identifico
                    filename = '/home/administrator/obligatorio/ejercicio2_python/'+str(formatoppid)  #Cambio de Ubicacion /tmp/aux
